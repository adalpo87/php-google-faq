...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,300;0,400;0,
    500;1,300;1,400;1,500&display=swap" rel="stylesheet">
...
<body>
    <header>
        <section class="top-header">
            ...
            <h4 class="color-brand">Privacy e termini</h4>
        </section>
    ...
    <main>
        ...
        <?php 
            ...
            foreach($faqs as $faq){?>
                ...
                <p><?php foreach($faq["answer"] as $answer){
                    echo $answer;
                } ?></p>
